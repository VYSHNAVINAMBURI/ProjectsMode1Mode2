...
//		accountRepository.save(account3);
		...
		//accountService.withdraw(3L, 20);
		//accountService.transfer(3L, 2L, 50);
		
//		User user1 = new User("raj", "raj", "r@r.com", "54545455", "delhi",
//				new String[] { "ROLE_ADMIN", "ROLE_MGR", "ROLE_CLERK" }, true);
//		User user2 = new User("ekta", "ekta", "e@r.com", "54545455", "delhi", new String[] { "ROLE_MGR", "ROLE_CLERK" },
//				true);
//
//		User user3 = new User("gunika", "gunika", "g@r.com", "54545455", "delhi", new String[] { "ROLE_CLERK" }, true);
//		User user4 = new User("keshav", "keshav", "k@r.com", "54545455", "delhi", new String[] { "ROLE_CLERK" }, true);
//
